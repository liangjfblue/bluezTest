...
const char *bt_compidtostr(int compid)
{
	...
	case 407:
		return "WiSilica Inc";
	case 408:
		return "VENGIT Korl谩tolt Felel艖ss茅g疟 T谩rsas谩g";
	case 409:
	...
	case 591:
		return "Schneider Schreibger盲te GmbH";
	case 592:
	...
	case 629:
		return "Geotab";
	case 630:
		return "E.G.O. Elektro-Ger盲tebau GmbH";
	case 631:
		return "bewhere inc";
	case 632:
	...
	case 636:
		return "Aseptika Ltd";
	case 637:
		return "HUAWEI Technologies Co., Ltd. ( 鍗庝负鎶�鏈湁闄愬叕鍙� )";
	case 638:
	...
	case 677:
		return "Tendyron Corporation ( 澶╁湴铻嶇鎶�鑲′唤鏈夐檺鍏徃 )";
	case 678:
	...
	case 709:
		return "Lenovo (Singapore) Pte Ltd. ( 鑱旀兂锛堟柊鍔犲潯锛� )";
	case 710:
	...
	case 741:
		return "Espressif Incorporated ( 涔愰懌淇℃伅绉戞妧(涓婃捣)鏈夐檺鍏徃 )";
	case 742:
		return "Unwire";
	case 743:
